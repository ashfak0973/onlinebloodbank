...
$sql=mysql_query("SELECT  `email`, `bloodgroup`, `contact`, `nbags`,`demail` FROM `donorrequest`");
...
if($epr=='Delete')
{
	...
	if($delete)
	{
		header("location: admindonorrequest.php");
	}
	else
...
<body  id="page-top">
	...
	<br/>
        ...
        <div ><br/><br/><br/>
	<center><h3 style="color:white;">All Donation Requests<font color="white"></h3></center><br/><br/><br/>
<style>
table {
...
<div >  <table align="center" cellspacing="0" cellpadding="0" width="1000" >
  <thead >
	<th align= "center" >Acceptor E-mail</th>
    <th>Blood Group</th>
    <th>Contact</th>
