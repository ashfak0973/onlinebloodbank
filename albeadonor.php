...
<body id="page-top">
 ...
 <header>
        ...
        <div class="container">
            <div class="row">
                <div ></br></br></br></br></br>
                    <center><h3 style= "font-size: 40px;color: wite";>Be a donor</h3></center>
					<form action="donorprocess.php" method="POST">
					<div class="login">
...
<input type="text" placeholder="Last donation date" id="blood" name="lastdonation">
...
<input type="text" placeholder="Location" id="location" name="location">
  ...
  <a href="login.html" class="forgot">Already a member?</a>
