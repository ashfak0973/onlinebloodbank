...
<body  id="page-top">
	...
	<input color= "#000" placeholder="Search by bloodgroup" name="term" ><input type="submit" value="Submit" name="search" />
	</form></center>
	<br/><br/><br/>
...
td, th {
	...
	<u><center><h3 style="color:white;">Available Donors<font color="white"></h3></center></u>
<br/><br/><br/>
